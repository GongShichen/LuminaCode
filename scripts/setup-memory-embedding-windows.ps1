...
$ortRelease = "1.26.0"
$ortArchive = "onnxruntime-win-x64-$ortRelease.zip"
$ortHash = "6ebe99b5564bf4d029b6e93eac9ff423682b6212eade769e9ca3f685eaf500b4"
...
function Install-Embedding {
    ...
    if (-not (Test-Path $runtimeLibrary)) {
        ...
        Copy-Item -LiteralPath $source.FullName -Destination $runtimeLibrary -Force
